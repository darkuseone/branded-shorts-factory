...
CURATED: dict[str, dict] = {
    ...
    # Restored bank (these clips lived in the repo root before the assets
    # reshuffle). Curated by hand rather than left to the generic fallback —
    # an untagged meme is a meme the policy will never place well.
    "eto-chto-takoe-a.mp4": {
        "title": "Это что такое, а?",
        "humor": "misconception",
        "beats": ["misconception", "hook_punch"],
        "tags": ["что-это", "непонятно", "вопрос", "разбор"],
        "intensity": "mid",
        "max_use": 1.4,
        "note": "перед разбором странного объекта/графика",
    },
    "kakuyu-psikhushku.mp4": {
        "title": "Какую психушку",
        "humor": "absurd_scale",
        "beats": ["absurd_scale", "doubt"],
        "tags": ["безумие", "психушка", "перебор"],
        "intensity": "mid",
        "max_use": 1.4,
        "note": "когда цифра или идея звучит клинически безумно",
    },
    "ne-posporish-goblin-puchkov.mp4": {
        "title": "Не поспоришь",
        "humor": "deadpan_accept",
        "beats": ["deadpan_accept", "praise_irony"],
        "tags": ["согласие", "факт", "не-поспоришь", "deadpan"],
        "intensity": "soft",
        "max_use": 1.3,
        "note": "после неоспоримого факта или тавтологии",
    },
    "nichego-strashnogo.mp4": {
        "title": "Ничего страшного",
        "humor": "deadpan_accept",
        "beats": ["absurd_scale", "deadpan_accept"],
        "tags": ["спокойствие", "катастрофа", "преуменьшение", "deadpan"],
        "intensity": "soft",
        "max_use": 1.4,
        "note": "лучший ответ на катастрофическое число — сделать вид, что всё ок",
    },
    "nuzhno-prinyat-uspokoitelnoe.mp4": {
        "title": "Нужно принять успокоительное",
        "humor": "despair",
        "beats": ["absurd_scale", "reveal_twist"],
        "tags": ["успокоительное", "перегруз", "нервы"],
        "intensity": "mid",
        "max_use": 1.5,
        "note": "когда масштаб уже не укладывается в голову",
    },
    "o-privet.mp4": {
        "title": "О, привет",
        "humor": "reveal_twist",
        "beats": ["reveal_twist", "hook_punch"],
        "tags": ["появление", "привет", "внезапно", "новый-игрок"],
        "intensity": "soft",
        "max_use": 1.2,
        "note": "в кадр входит новая сущность — компания, зонд, модель",
    },
    "oh-my-god-wowww.mp4": {
        "title": "Oh my God wow",
        "humor": "shock",
        "beats": ["reveal_twist", "absurd_scale"],
        "tags": ["шок", "вау", "восторг"],
        "intensity": "mid",
        "max_use": 1.3,
    },
    "tebya-ne-sprashivayut.mp4": {
        "title": "Тебя не спрашивают",
        "humor": "dismiss",
        "beats": ["misconception"],
        "tags": ["отмахнуться", "мимо", "не-спрашивают"],
        "intensity": "mid",
        "max_use": 1.3,
        "note": "закрыть популярный миф одной репликой",
    },
    "ty-chto-s-uma-soshel.mp4": {
        "title": "Ты что, с ума сошёл",
        "humor": "doubt",
        "beats": ["doubt", "absurd_scale"],
        "tags": ["сомнение", "безумие", "серьёзно"],
        "intensity": "mid",
        "max_use": 1.4,
    },
    "vsego-horoshego.mp4": {
        ...
        "humor": "outro_joke",
        "beats": ["context_end"],
        "tags": ["прощание", "конец", "выход"],
        "intensity": "soft",
        "max_use": 1.3,
        "note": "мягкий выход из отступления, не в самый закрывающий кадр",
    },
    "ya-hochu-kupit-computer.mp4": {
        "title": "Я хочу купить компьютер",
        "humor": "meta",
        "beats": ["context_end", "core1_to_core2"],
        "tags": ["компьютер", "железо", "техника", "gpu"],
        "intensity": "soft",
        "max_use": 1.3,
        "note": "к темам про железо, вычисления, датацентры",
    },
    "ya-zh-adekvatnyi.mp4": {
        "title": "Я ж адекватный",
        "humor": "forced_composure",
        "beats": ["deadpan_accept", "doubt"],
        "tags": ["адекватность", "самооправдание", "спокойно"],
        "intensity": "soft",
        "max_use": 1.4,
    },
    "БЕГИ СУКА БЕГИ.mp4": {
        ...
        "humor": "fear",
        "beats": ["absurd_scale", "reveal_twist"],
        "tags": ["паника", "беги", "опасность"],
        "intensity": "hard",
        "max_use": 1.3,
        "note": "только на реальной угрозе в сюжете, не на статистике",
    },
    "МЫ В ДЕРЬМЕ.mp4": {
        "title": "Мы в дерьме",
        "humor": "despair",
        "beats": ["absurd_scale", "reveal_twist"],
        "tags": ["провал", "плохо", "приплыли"],
        "intensity": "hard",
        "max_use": 1.3,
    },
    "ПРОСТО ОХУЕННО.mp4": {
        ...
        "humor": "praise_irony",
        "beats": ["praise_irony", "deadpan_accept"],
        "tags": ["восторг", "ирония", "браво"],
        "intensity": "hard",
        "max_use": 1.3,
    },
    # Crude register — kept in the bank, but never auto-placed on a science
    # beat. safe_for_science=False is the gate the policy honours.
    "dai-prisunut.mp4": {
        "title": "Дай присунуть",
        "humor": "demand",
        "beats": ["hook_punch"],
        "tags": ["хочу", "требование", "жадность"],
        "intensity": "hard",
        "safe_for_science": False,
        "max_use": 1.2,
    },
