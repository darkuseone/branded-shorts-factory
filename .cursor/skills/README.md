...
| Skill | When |
| --- | --- |
| [`youtube-shorts-author`](youtube-shorts-author/SKILL.md) | Hooks, script craft, Nikita v3 RU, research-first news |
...
Related rules: `.cursor/rules/render-fix-loop.mdc`, `.cursor/rules/youtube-shorts-author.mdc`.
